...
import { AccountModel, AuthenticationModel, HashComparator, TokenGenerator, LoadAccountByEmailRepository, UpdateAccessTokenRepository } from './db-authentication-protocols'
